import { moduleName, socketId } from "../scripts/consts.js";
import { SocketAction } from "../scripts/socket-handler.js";

const { ApplicationV2, HandlebarsApplicationMixin } = foundry.applications.api;

export const observerPickerApp = "phyvision-observer-picker";

export class ObserverPickerApp extends HandlebarsApplicationMixin(ApplicationV2) {

    static DEFAULT_OPTIONS = {
        id: observerPickerApp,
